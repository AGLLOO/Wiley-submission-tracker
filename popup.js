...
async function checkForUpdate() {
  ...
  try {
    // 请将下面的 URL 替换为你自己的 version.json 地址
...
async function loadStatus() {
  ...
  document.getElementById('currentId').innerText = id ? id.slice(0,8)+'...' : '未设置';
